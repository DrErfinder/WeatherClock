execute if entity @a[nbt={SelectedItem: {id: "minecraft:clock"}},tag=!weather_clock_shown,tag=!weather_clock_config_hotbar_off] run function weather_clock:display_player
